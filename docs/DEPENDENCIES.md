...
Blocked latest versions in this pass:

- Bun 1.4.0 and `@types/bun@1.4.0` until CI and `packageManager` move together.
- `oxlint@1.80.0` and `oxfmt@0.65.0` until a dedicated OXC pin update.
...
| Quality            | `vitest@4.1.11`, `oxlint@1.78.0`, `oxfmt@0.63.0`, `@testing-library/react@16.3.3`, `jsdom@30.0.1`, `playwright@1.62.1`, `tsx@4.23.12` | The current stack supplies faster lint/format passes, Node 26 DOM coverage, and browser verification. Formatter output is treated as a required gate.                           | [Vitest releases](https://github.com/vitest-dev/vitest/releases), [Oxc releases](https://github.com/oxc-project/oxc/releases), [Playwright releases](https://github.com/microsoft/playwright/releases)  |
...
| Backend            | `hono@4.13.5`, `effect@3.22.1`, `js-yaml@5.4.1`, `sharp@0.35.3`                                                                       | These packages own HTTP routing, schemas/effects, manifest parsing, and image processing. Current server build, style validation, and asset audit cover their active contracts. | [Hono releases](https://github.com/honojs/hono/releases), [Effect releases](https://github.com/Effect-TS/effect/releases), [Sharp changelog](https://sharp.pixelplumbing.com/changelog/)                |
