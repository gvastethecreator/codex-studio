...
const spec: Spec = {
  ...
  updates: {
    ...
    'SP04-002': {
      ...
      briefs: [
        'Silver Age cosmic comic image of an adult alchemist in a hooded robe prying open a lead casket that erupts in black energy-dot crackle, his hands foreshortened toward the lens, bright magenta, cyan and yellow flats. Single image, no panels, balloons, text or logo.',
        'Silver Age cosmic comic image of an invented colossal armored star-titan stepping over a cratered moon, tiny rocket ships at its ankle for scale, radial burst behind, blocky square-cornered ink. Single image, no panels, balloons, text or logo.',
