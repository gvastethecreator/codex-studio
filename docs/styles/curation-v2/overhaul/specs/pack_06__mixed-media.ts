  ...
  updates: {
    ...
    'SP06-080': {
      ...
      briefs: [
        ...
        'Multi-layer studio stencil of a vintage motorcycle with no badges, chrome built from light and dark grey layers, a red tank accent and crisp bridged cuts. No text or logo.',
      ],
    },
  },
};
