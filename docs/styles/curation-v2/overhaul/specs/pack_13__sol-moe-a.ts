...
// Slice of life and moe (part A): the DNA already holds portable line, cel and timing mechanics,
// so this pass writes three original briefs per preset that show each mechanic clearly. Everyday
// moments often carry a small fantasy twist so the cards stay memorable.
const spec: Spec = {
  pack: 'pack_13',
