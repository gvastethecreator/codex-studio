...
// Shojo, magical girl and visionary classics (part B): briefs only; the DNA already holds the
// portable line and cel mechanics. Every brief uses original characters and places.
const spec: Spec = {
  pack: 'pack_13',
