  ...
  updates: {
    ...
    'SP06-089': {
      ...
      briefs: [
        ...
        'Text-mode roguelike map of a forest clearing with a ring of standing stones, green glyph trees and grey block stones in 16 ANSI colors. No readable words or logo.',
      ],
    },
    'SP06-090': {
      dna: px({
