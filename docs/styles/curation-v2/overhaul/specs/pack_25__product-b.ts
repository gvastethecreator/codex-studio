...
const spec: Spec = {
  ...
  updates: {},
  creates: [
    P('R-PRD-11', 'Open-Core Appliances', 'open housing revealing core product', 'open-core', {
      aesthetic: 'Open-Core Appliances: one structural opening in the housing reveals how the functional core sits inside the outer shell.',
      subject_treatment: "Open the prompt's product housing at one structural zone that reveals the relationship between its working core and its shell, with visible supports.",
      color_and_tone: 'Controlled contrast between core and housing, with every connection kept visible.',
      lighting_and_shadow: 'One common light that shows depth inside without turning it into a stage.',
      texture_and_material: 'Sober finishes on housing and core, with clear edges and supports.',
      camera_and_composition: 'The opening aimed at understanding the function, not at showing every part.',
      atmosphere_and_mood: 'Constructive transparency and contained curiosity, honest about how it works.',
      rendering_and_quality: 'Clean concept render where the opening never cuts a support or floats the core.',
    ...
    P('R-PRD-12', 'Continuous Handle Objects', 'one-path handle and body product', 'continuous-handle', {
      aesthetic: 'Continuous Handle Objects: handle and body grow from one continuous path of material, with readable transitions of thickness.',
      subject_treatment: "Grow the prompt's product handle and body from one continuous material path with a readable change of thickness and a generous grip gap.",
      ...
      texture_and_material: 'Sober material, seamless where continuity is proposed and jointed where it ends.',
      ...
      rendering_and_quality: 'Clean concept render where continuity holds from side and back views.',
    ...
    P('R-PRD-13', 'Counterweighted Desk Tools', 'visible counterweight product', 'counterweight', {
      aesthetic: 'Counterweighted Desk Tools: one visible heavy mass balances a light working element and shows the direction of use.',
      subject_treatment: "Balance the prompt's light working element with one visible support mass that expresses direction and use, the load path making sense.",
      ...
      texture_and_material: 'Materials of visibly different apparent density, heavy base and light arm.',
      camera_and_composition: 'A stable visual center of support with the light arm aimed at the task.',
    ...
    }, ['object that seems to be falling', 'ornamental counterweight', 'stability claimed without calculation'], [
    ...
    P('R-PRD-14', 'Color-Coded Function Modules', 'color and shape coded modular product', 'color-modules', {
      aesthetic: 'Color-Coded Function Modules: modules told apart by shape and color make their function and swap-ability visible at a glance.',
      subject_treatment: "Split the prompt's product into modules by function, each recognizable by shape, joint and color together.",
    ...
    P('R-PRD-15', 'Inflated Surface Hardpoints', 'soft volume with rigid anchors', 'inflated-hardpoint', {
      aesthetic: 'Inflated Surface Hardpoints: apparently soft volumes fixed to clearly rigid points, a constructive contrast between plush and precise.',
      subject_treatment: "Fix the prompt's soft volumes to a few clear rigid anchors, keeping tension and the function of each contact point.",
      ...
      rendering_and_quality: 'Clean concept render where every major deformation comes from an anchor.',
    ...
    P('R-PRD-16', 'Perforation-Gradient Objects', 'graded perforation surface product', 'perforation-gradient', {
      aesthetic: 'Perforation-Gradient Objects: openings that grow or shrink by zone to express declared airflow, sound or visibility across the product.',
      subject_treatment: "Vary the size or density of perforations across the prompt's product by functional zone, with coherent margins and solid ligaments.",
      ...
      texture_and_material: 'Matte surface, clean-edged perforations and uniform apparent thickness.',
      camera_and_composition: 'The gradient aimed at one functional zone, smooth areas left for grip and controls.',
    ...
    P('R-PRD-19-NEW', 'Stacked Ring Forms', 'stacked ring product construction', 'stacked-ring', {
      aesthetic: 'Stacked Ring Forms: products built from a column of stacked rings and discs, each ring a separate part with its own material and role.',
      subject_treatment: "Build the prompt's product as a stack of rings and discs, each ring one part with its own role, so function reads from bottom to top.",
      color_and_tone: 'Alternating ring materials in a tight palette with one accent ring.',
      lighting_and_shadow: 'Soft side light catching every ring edge and the small gaps between them.',
      texture_and_material: 'Machined, turned and cast rings in matte and satin finishes.',
      camera_and_composition: 'Upright stack seen at eye level, the rhythm of rings reading clearly.',
      atmosphere_and_mood: 'Sculptural and totemic, precise and satisfying like a finished lathe part.',
    ...
    P('R-PRD-17', 'Monolithic Material Finish', 'monolithic material finish modifier', 'monolithic-finish', {
      aesthetic: 'Monolithic Material Finish: a modifier that wraps an existing product in one continuous finish while every joint, control and opening stays in place.',
      subject_treatment: "Apply one continuous finish to the prompt's existing product geometry, keeping its seams, controls and openings exactly where they are.",
    ...
    P('R-PRD-18', 'Exploded Assembly Board', 'product assembly design board profile', 'assembly-board', {
      aesthetic: 'Exploded Assembly Board: a design board that lays the product\'s real parts apart along assembly axes, beside a small assembled view for control.',
      subject_treatment: "Lay the prompt's product parts apart along assembly axes on a clean board, keeping shape, orientation and correspondence, with a small assembled view.",
      ...
      texture_and_material: 'Original materials and thickness kept, with only the supplied parts shown.',
      camera_and_composition: 'Compact ordered layout with readable axes and an assembled control view.',
      atmosphere_and_mood: 'Constructive understanding and sequence, calm like a designer\'s pin-up board.',
      rendering_and_quality: 'Part count and joining points match between assembled and exploded views.',
    ...
    P('R-PRD-20', 'Repair-Access Concept', 'repair access sequence profile', 'repair-access', {
      aesthetic: 'Repair-Access Concept: a three-step visual sequence showing the product closed, opened and with one part removed, the same parts and camera throughout.',
      subject_treatment: "Show the prompt's product in three steps, closed, cover removed and one part taken out, keeping geometry and part order identical.",
      ...
      rendering_and_quality: 'The sequence could run backwards without any part passing through another.',
