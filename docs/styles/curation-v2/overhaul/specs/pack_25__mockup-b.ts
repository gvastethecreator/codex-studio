...
const spec: Spec = {
  ...
  updates: {},
  creates: [
    M('R-MCK-11', 'Floating Assembly Presentation', 'suspended component presentation profile', 'floating-assembly', {
      aesthetic: 'Floating Assembly Presentation: the real components of a product or package suspended apart on clear axes, with a small assembled view for control.',
      subject_treatment: "Suspend the prompt's existing components apart on clear axes in an orderly presentation, keeping their number, relationships and the exact brand artwork.",
    ...
    M('R-MCK-13', 'Neutral Apparel Hanging', 'hanging garment presentation profile', 'apparel-hanging', {
      aesthetic: 'Neutral Apparel Hanging: a garment hanging with a gentle natural drape on a discreet support, its cut and print placement kept exact.',
      subject_treatment: "Hang the prompt's garment with a moderate drape on a discreet support, keeping its cut, print placement and exact text.",
      ...
      texture_and_material: 'Moderate fabric texture and defined seams, the garment in new condition.',
      camera_and_composition: 'Full garment or a declared crop on a steady axis with the print readable.',
      atmosphere_and_mood: 'Sober product presentation, focused, uncluttered and quietly confident.',
    ...
    M('R-MCK-15', 'Screen-in-Device Preservation', 'screen placed in device profile', 'screen-device', {
      aesthetic: 'Screen-in-Device Preservation: an existing screen design placed inside a generic device frame with every control and word exactly preserved.',
      subject_treatment: "Place the prompt's screen design inside a generic unbranded device as a locked layer, keeping its aspect ratio, controls and every word exact.",
      color_and_tone: 'Screen colors untouched with enough brightness and limited reflections.',
      lighting_and_shadow: 'Ambient light kept off the controls, reflections only outside key reading.',
      texture_and_material: 'Sober generic device and a sharp screen with every pixel crisp.',
      camera_and_composition: 'Moderate perspective, kept aspect ratio and a frame that never crops content.',
    ...
    M('R-MCK-16', 'Multi-Support Identity Set', 'identity across objects set profile', 'identity-set', {
      aesthetic: 'Multi-Support Identity Set: one locked identity applied across several different objects at believable scales, symbol and wordmark identical everywhere.',
      subject_treatment: "Apply the prompt's locked identity to several different objects, symbol, wordmark and colors identical on each, with believable relative scales.",
      ...
      camera_and_composition: 'A family composition with believable scales and the mark visible on each.',
    ...
    M('R-MCK-17', 'Weathered Public Display', 'aged public poster mockup profile', 'weathered-display', {
      aesthetic: 'Weathered Public Display: a preserved graphic placed on an aged public support, with wear limited to the frame and surroundings.',
      subject_treatment: "Place the prompt's poster or graphic on a weathered public panel or wall, wear kept on the support while the artwork and text stay exact.",
    ...
    M('R-MCK-18', 'Gallery Plinth Presentation', 'museum plinth product presentation', 'gallery-plinth', {
      aesthetic: 'Gallery Plinth Presentation: a minimal plinth and quiet space present the object like an exhibit, with a consistent believable scale.',
      subject_treatment: "Present the prompt's product on a minimal plinth in a quiet gallery space, keeping its identity, size and exact brand text.",
      ...
      atmosphere_and_mood: 'Contemplative presentation and formal clarity, quiet and slightly reverent.',
    ...
    M('R-MCK-20', 'Lighting-Angle Contact Sheet', 'product lighting test contact sheet', 'lighting-contact', {
      aesthetic: 'Lighting-Angle Contact Sheet: the same object and artwork shown in a grid of equal cells, changing one light or camera condition per cell.',
      subject_treatment: "Show the prompt's product in a grid of equal cells, each changing only one declared light or camera condition, the artwork kept exact.",
      color_and_tone: 'Source color and reference exposure constant across cells.',
      lighting_and_shadow: 'A declared set of frontal, side and raking lights at comparable intensity.',
    ...
    M('R-MCK-03-NEW', 'Brand-Shape Set Build', 'set built from brand shapes style', 'brand-shape-set', {
      aesthetic: 'Brand-Shape Set Build: the product presented inside a studio set built from oversized versions of its own brand shapes and colors.',
      subject_treatment: "Present the prompt's product inside a studio set made from giant physical versions of its own brand shapes and colors, the product and brand text kept exact.",
      color_and_tone: 'The brand palette turned into bold physical set blocks with one neutral floor.',
      lighting_and_shadow: 'Clean studio light with crisp shadows cast by the giant shapes.',
      texture_and_material: 'Matte painted set pieces, smooth and handmade-looking, beside the real product.',
      camera_and_composition: 'Product at the center of a graphic set, shapes framing but never covering it.',
      atmosphere_and_mood: 'Playful, bold and art-directed, a brand you can walk into.',
      rendering_and_quality: 'Crisp editorial set photography with the product and label razor sharp.',
    ...
    M('R-MCK-09-NEW', 'Giant Product Miniature World', 'giant product in miniature scene style', 'giant-miniature', {
      aesthetic: 'Giant Product Miniature World: the product shown towering over a detailed miniature world, with tiny figures reacting to it like a landmark.',
      subject_treatment: "Place the prompt's product at giant scale in a detailed miniature world of tiny people, vehicles and buildings, keeping the product and brand text exact.",
      color_and_tone: 'Bright miniature colors around the product, with its own palette kept.',
      lighting_and_shadow: 'Soft sunlight with a long product shadow falling across the tiny world.',
      texture_and_material: 'Model-railway miniatures, tiny figures and the product\'s real material.',
    ...
    M('R-MCK-14-NEW', 'Landscape Billboard Mockup', 'giant billboard in landscape style', 'landscape-billboard', {
      aesthetic: 'Landscape Billboard Mockup: a campaign poster shown on a huge freestanding billboard placed in a wide, dramatic open landscape.',
      subject_treatment: "Place the prompt's poster or ad on a giant freestanding billboard in a wide open landscape, the artwork and every word kept exact and readable.",
      color_and_tone: 'Landscape tones as a subordinate backdrop to the billboard artwork.',
      lighting_and_shadow: 'Natural light matched between the billboard face and the land around it.',
      texture_and_material: 'A clean billboard face, steel structure and real terrain around it.',
      camera_and_composition: 'Wide shot with the billboard dominant and the landscape giving scale.',
      atmosphere_and_mood: 'Epic, lonely and cinematic, a message standing alone in the world.',
      rendering_and_quality: 'Photographic landscape realism with the billboard art crisp and square to view.',
    ...
    M('R-MCK-19-NEW', 'Shop-Window Display Set', 'shop window display mockup style', 'shop-window', {
      aesthetic: 'Shop-Window Display Set: the product presented as the hero of a designed shop-window display, seen from the street through the glass.',
      subject_treatment: "Stage the prompt's product as the hero of a designed shop window seen from the street, with props that support it and the brand text kept exact.",
      color_and_tone: 'A window palette built around the product, with warm interior light against the street.',
      lighting_and_shadow: 'Warm window spotlights inside and soft street light outside the glass.',
      texture_and_material: 'Clean glass with faint reflections, painted props and the real product.',
      ...
      rendering_and_quality: 'Crisp photographic window display with light reflections that never cover the label.',
