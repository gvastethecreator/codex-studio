...
const spec: Spec = {
  ...
  updates: {},
  creates: [
    A('R-APP-11', 'Tensioned Membrane Tokens', 'stretched membrane app icon', 'tensioned-membrane', {
      aesthetic: 'Tensioned Membrane Tokens: one smooth surface stretched between three or four fixed points forms an expressive, clearly built icon.',
      subject_treatment: "Stretch the prompt's subject as one membrane between three or four persistent points, letting its hollows and curves explain the metaphor.",
      color_and_tone: 'One main color in broad value bands, with the support points in a secondary contrast.',
      lighting_and_shadow: 'Diffuse light revealing curvature and tension with soft, even highlights.',
      ...
      rendering_and_quality: 'The tension points stay identifiable even when the view shifts slightly.',
    ...
    A('R-APP-12', 'Contour-Locked Miniatures', 'focused-detail miniature app icon', 'contour-locked', {
      aesthetic: 'Contour-Locked Miniatures: a simple calm outer mass with all functional detail gathered in one limited focal area.',
      subject_treatment: "Keep the prompt's subject with a simple outer contour and concentrate its functional detail in one limited region, about a third of the icon.",
      color_and_tone: 'High-contrast silhouette with the detail in a subordinate tonal range.',
      lighting_and_shadow: 'One soft light for the outer volume and a focused light only on the detail.',
      texture_and_material: 'Sober surfaces with minimal grain and fine detail only in the focus zone.',
      ...
      rendering_and_quality: 'The miniature reads at small size even when the focal detail disappears.',
      key_features: 'simple outer mass; one detail zone; calm silhouette; local discovery',
    }, ['detail spread everywhere', 'generic object with one ornament', 'silhouette broken by accessories'], [
    ...
    A('R-APP-13', 'Interlocking Toy Volumes', 'interlocking block app icon', 'interlocking-toy', {
      aesthetic: 'Interlocking Toy Volumes: pieces with obvious original connectors lock together into one compact, recognizable metaphor.',
      subject_treatment: "Assemble the prompt's subject from a few pieces with an original, obvious connector system, every connection explaining the function.",
      ...
      camera_and_composition: 'Compact build with visible connections and no loose meaningless parts.',
      atmosphere_and_mood: 'The pleasure of building and a clear assembly, playful and precise.',
      rendering_and_quality: 'The pieces can be mentally taken apart and the fit still makes sense.',
    ...
    A('R-APP-14', 'Cut-Pixel Medallions', 'pixel cluster emblem app icon', 'cut-pixel-medallion', {
      aesthetic: 'Cut-Pixel Medallions: stepped pixel clusters and broad flat value planes build compact illustrative emblems on one fixed logical grid.',
      subject_treatment: "Build the prompt's subject as a compact emblem of stepped pixel clusters and large planes on one fixed logical grid such as 32, 40 or 48 pixels.",
      ...
      rendering_and_quality: 'Shown at logical size and at a whole-number enlargement with the same palette.',
    ...
    A('R-APP-15', 'Stitched-Edge Symbols', 'stitched patch app icon', 'stitched-edge', {
      aesthetic: 'Stitched-Edge Symbols: cut pieces of flat material joined by large controlled stitches that explain how the parts connect.',
      subject_treatment: "Join the prompt's subject from a few cut pieces with large visible stitches where they meet, keeping the silhouette clean.",
      ...
      rendering_and_quality: 'The figure reads without the stitches, which only add the relationship.',
    ...
    A('R-APP-16', 'Orbiting Part Icons', 'orbit-linked app icon', 'orbiting-part', {
      aesthetic: 'Orbiting Part Icons: one main form and one secondary element linked by an open asymmetric arc that represents a real relationship.',
      subject_treatment: "Link the prompt's subject with one secondary element through an open arc that stands for a real relationship in the app.",
      color_and_tone: 'Dominant primary mass, an accent secondary element and a lower-contrast arc.',
      ...
      camera_and_composition: 'Asymmetric open orbit with the secondary element away from key traits.',
    ...
    A('R-APP-17', 'Soft Enamel Finish', 'enamel pin finish modifier', 'soft-enamel', {
      aesthetic: 'Soft Enamel Finish: a surface modifier that fills an existing icon with smooth colored enamel between slightly raised metal borders.',
      subject_treatment: "Apply enamel only to the regions of the prompt's existing icon or mark, keeping its contour, openings and colors exactly as they are.",
      color_and_tone: 'Source colors kept, with even enamel coverage and borders of a separate value.',
    ...
    A('R-APP-18', 'Translucent Edge Finish', 'translucent edge finish modifier', 'translucent-edge', {
      aesthetic: 'Translucent Edge Finish: a surface modifier that turns an existing icon into a solid translucent body with light gathering along its thickness and edges.',
      subject_treatment: "Change only the transmission and edge glow of the prompt's existing icon, keeping its silhouette locked and its front readable.",
      color_and_tone: 'Source palette kept, the transparency never fading the figure away.',
      lighting_and_shadow: 'Broad controlled edge light with a readable front face and a tight halo.',
      texture_and_material: 'Translucent material of moderate thickness, sober refraction and smooth surface.',
      camera_and_composition: 'Framing and orientation of the input kept, background only for contrast.',
    ...
    A('R-APP-19', 'Platform Mask Preview', 'app icon mask preview sheet', 'platform-mask', {
      aesthetic: 'Platform Mask Preview: one app icon shown under several container masks and backgrounds side by side, the artwork itself unchanged.',
      subject_treatment: "Show the prompt's subject icon unchanged inside square, circle and rounded-square masks and on light and dark grounds, with the same scale.",
      color_and_tone: 'Artwork colors kept, alternative backgrounds only as control views.',
      lighting_and_shadow: 'The same lighting in every mask so the comparison only measures the crop.',
    ...
    A('R-APP-20', 'Icon Family Reduction', 'app icon family size sheet', 'icon-family-reduction', {
      aesthetic: 'Icon Family Reduction: a family of related app icons built from one shared rule, shown large and at small sizes on one sheet.',
      subject_treatment: "Present the prompt's subject as a family of related icons from shared rules, each shown large and reduced with only local simplifications.",
      ...
      texture_and_material: 'Materials at one consistent scale, fine detail reduced before sharpening.',
      camera_and_composition: 'Rows of large and small versions with equal optical weight.',
      atmosphere_and_mood: 'Clear kinship across the set without making every object the same shape.',
      rendering_and_quality: 'Each small version keeps its own metaphor and the shared system traits.',
