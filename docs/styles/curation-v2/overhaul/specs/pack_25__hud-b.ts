...
const spec: Spec = {
  ...
  updates: {},
  creates: [
    H('R-HUD-11', 'Vector Sweep Instruments', 'vector sweep instrument HUD', 'vector-sweep', {
      aesthetic: 'Vector Sweep Instruments: sweeps and vectors show orientation or measurement inside constant declared scales and reading limits.',
      subject_treatment: "Show the prompt's direction or measurement as clean vectors and a sweep inside declared limits and scales; keep every value and label exact.",
      color_and_tone: 'Bright main stroke, faint secondary grid and one accent for the selected value.',
      ...
      camera_and_composition: 'Fixed center and reading limits, labels clear of crossings and vectors traceable.',
    ...
    H('R-HUD-12', 'Layered Route Displays', 'layered route map HUD', 'layered-route', {
      aesthetic: 'Layered Route Displays: routes placed on separate graphic planes so crossings never confuse, while node positions stay fixed.',
      subject_treatment: "Separate the prompt's routes onto distinct planes while keeping every node position and connection exactly as supplied; keep labels exact.",
    ...
    H('R-HUD-13', 'Membrane Switch HUD', 'tensioned membrane control HUD', 'membrane-switch', {
      aesthetic: 'Membrane Switch HUD: apparent flexible surfaces stretched around controls and status regions, supported at clear points.',
      subject_treatment: "Place the prompt's controls and status regions on apparent flexible membranes held by coherent supports, with flat zones for reading; keep labels exact.",
      ...
      camera_and_composition: 'Grouped by task with flat reading zones between gently raised controls.',
      atmosphere_and_mood: 'Contained organic tactility with an apparent response under the finger.',
      rendering_and_quality: 'Stretch never changes the position, label or usable size of a control.',
    ...
    H('R-HUD-14', 'Eroded Enamel Console', 'worn enamel plate HUD', 'eroded-enamel', {
      aesthetic: 'Eroded Enamel Console: solid enamel plates worn at their edges, with clean protected reading zones and a clear hierarchy.',
      subject_treatment: "Build the prompt's readouts on solid enamel plates with wear only at edges and contact points, keeping every reading zone clean and every value exact.",
      ...
      camera_and_composition: 'Aligned functional plates with clear labels and fixings only where needed.',
    ...
    H('R-HUD-15', 'Negative-Space Meters', 'void-fill capacity meter HUD', 'negative-space-meter', {
      aesthetic: 'Negative-Space Meters: openings inside stable shapes encode availability or load, the void growing with the value.',
      subject_treatment: "Encode the prompt's quantities as openings inside stable shapes, the void matching each value by a declared convention; keep every value and label exact.",
      ...
      camera_and_composition: 'One meter per variable with a visible reference and room for a label.',
    ...
    H('R-HUD-16', 'Segmented Light Channels', 'counted light segment HUD', 'segmented-light', {
      aesthetic: 'Segmented Light Channels: discrete lit segments grouped in clear channels show state, each gap between them kept visible.',
      subject_treatment: "Split the prompt's values into counted lit segments grouped by variable, the number of lit segments matching the data exactly; keep labels exact.",
      ...
      camera_and_composition: 'Grouped by function with aligned readings and every channel going somewhere.',
    ...
    H('R-HUD-20-NEW', 'Contour-Line Gauges', 'topographic contour fill gauge HUD', 'contour-gauge', {
      aesthetic: 'Contour-Line Gauges: meters filled with stacked contour lines like a topographic map, the number of rings rising with each value.',
      subject_treatment: "Draw the prompt's values as shapes filled with nested contour lines, one ring per declared step, so the level reads like elevation; keep labels exact.",
      ...
      camera_and_composition: 'Frontal gauges with a clear step legend and the current line emphasized.',
      atmosphere_and_mood: 'Exploratory and grounded, like reading terrain rather than a machine.',
      rendering_and_quality: 'The count of contour steps matches each value, with no invented rings.',
    ...
    H('R-HUD-17', 'Diegetic Cockpit Layout', 'in-world cockpit HUD profile', 'diegetic-cockpit', {
      aesthetic: 'Diegetic Cockpit Layout: readouts placed on the zones of a physical in-world panel according to priority and the pilot\'s field of view.',
      subject_treatment: "Place the prompt's readouts on zones of an in-world control panel by priority, main readings in the frontal field; keep every value exact.",
      color_and_tone: 'Data contrast independent of the panel material, alerts backed by shape.',
      lighting_and_shadow: 'Sober cockpit lighting that keeps priority instruments reflection-free.',
      texture_and_material: 'Consistent panel material and plausible fixings with purposeful detail.',
      camera_and_composition: 'Main readings inside the frontal field, secondary ones in reachable periphery.',
      atmosphere_and_mood: 'In-world presence and orientation, grounded in a believable seat.',
      rendering_and_quality: 'The camera never hides required information or changes its hierarchy.',
    ...
    H('R-HUD-18', 'Peripheral Combat Overlay', 'edge-placed gameplay overlay profile', 'peripheral-overlay', {
      aesthetic: 'Peripheral Combat Overlay: gameplay information pushed to the screen edges so the center of action stays free, with clear priorities.',
      subject_treatment: "Place the prompt's gameplay information at the screen periphery by priority, keeping the central action zone clear; keep every value and slot count exact.",
      color_and_tone: 'Critical data in high contrast, secondary data sober, states backed by shape.',
      lighting_and_shadow: 'A graphic overlay that keeps the scene fully readable beneath it.',
      texture_and_material: 'Sharp edges and lightly opaque panels where the background needs context.',
      camera_and_composition: 'Clear center, resources in one stable zone and short events in another.',
    ...
    H('R-HUD-19', 'Tactical Map Stack', 'layered tactical map screen profile', 'tactical-map-stack', {
      aesthetic: 'Tactical Map Stack: a map, switchable route layers and linked info cards kept in sync by stable ids and coordinates.',
      subject_treatment: "Show the prompt's map with switchable route layers and a card for the selected item, every node, id and coordinate kept exact.",
      color_and_tone: 'One bright active layer, faint secondary context and selection backed by outline.',
      ...
      camera_and_composition: 'Dominant map, compact layer controls and an inspector tied to selection.',
