...
// 70s and 80s retro anime (part A): briefs only; the DNA already holds each hand-inked cel look.
// Original characters in retro genres (space opera, heist, mecha, slapstick, melodrama).
const spec: Spec = {
  pack: 'pack_16',
  ...
  updates: {
    ...
    'SP05-003': {
      briefs: [
        ...
        'On a wet rooftop at dawn, a lady thief and the customs officer who chased her for ten years share one umbrella and one thermos of coffee, neither willing to leave first. No readable text or logo.',
      ],
    },
    'SP05-004': {
      briefs: [
    ...
    'SP05-303': {
      briefs: [
        'A rusty steam tram crosses a sea of clouds on rails of moonlight, and an old conductor with a lantern leans out of the window to pick a star off the track like ripe fruit. No readable text or logo.',
    ...
    'SP05-305': {
      briefs: [
        'A lovesick weather goddess from another planet sneezes on a flustered postal clerk and turns the entire shopping street into a snow globe in mid-July. No readable text or logo.',
        ...
        'A panicking bicycle courier pedals downhill chased by a stampede of jealous alien suitors on hover-scooters, while the cause of it all, a smug octopus prince, floats above eating shaved ice. No readable text or logo.',
      ],
    },
    'SP05-306': {
      briefs: [
