...
// 90s golden era anime: briefs only; each brief shows the preset's 90s cel mechanic with an
// original subject from its genre (tournament, space noir, cyber, western, drama, magic).
const spec: Spec = {
  pack: 'pack_16',
