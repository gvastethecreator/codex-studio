...
const spec: Spec = {
  ...
  creates: [
    K(
      'R-PKG-01',
      'Seam-Spanning Type',
      'type wrapping across package faces',
      'seam-spanning-type',
      {
        aesthetic:
        ...
        texture_and_material:
          'Clean ink on a sober board with crisp, well-defined edges and folds.',
        camera_and_composition:
          'Complete front hierarchy with a side continuation that adds rhythm.',
      ...
      [
        'text cut with no intent',
        'folds that alter letters',
        'label added like a patch',
        NO_CLAIMS,
      ],
      [
    ...
    K(
      'R-PKG-02',
      'Taxonomic Label Systems',
      'indexed variant label system',
      'taxonomic-label',
      {
        aesthetic:
    ...
    K(
      ...
      'window-counterform',
      {
        ...
        texture_and_material:
          'Sober board, a clean window edge and clear film only when specified.',
        camera_and_composition:
    ...
    K(
      ...
      'wraparound-band',
      {
        ...
        rendering_and_quality:
          'The reading order holds both on the flat dieline and when assembled.',
        key_features: 'wraparound bands; face-to-face sequence; front entry; resting ground',
      },
      [
        'invented story',
        'band covering information',
        'repeating decoration with no sequence',
        NO_CLAIMS,
      ],
      [
    ...
    K(
      ...
      [
        'fake microtext',
        'title hiding contents',
        'hierarchy based only on extreme size',
        NO_CLAIMS,
      ],
      [
    ...
    K(
      'R-PKG-08',
      'Quiet Diagram Packaging',
      'simple use-diagram packaging',
      'quiet-diagram',
      {
        aesthetic:
        ...
        camera_and_composition:
          'Diagram and text aligned, with a clear link between front and side.',
    ...
    K(
      'R-PKG-10',
      'Typographic Path Packaging',
      'type following package volume',
      'typographic-path',
      {
        aesthetic:
