  ...
  creates: [
    ...
    M(
      ...
      'hard-sun-shadow',
      {
        ...
        camera_and_composition:
          'The shadow works as a counterweight outside the main reading area.',
    ...
    M(
      ...
      'soft-tabletop',
      {
        ...
        rendering_and_quality:
          'The support never alters proportions or hides important information.',
    ...
    M(
      ...
      'fold-following',
      {
        ...
        color_and_tone:
          'Source colors kept, value changes coming only from light and surface angle.',
    ...
    M(
      'R-MCK-07',
      'Decal-on-Object Study',
      'decal placement on object profile',
      'decal-object',
      {
        aesthetic:
