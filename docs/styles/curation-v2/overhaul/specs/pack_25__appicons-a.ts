...
const spec: Spec = {
  ...
  updates: {},
  creates: [
    A('R-APP-01', 'Folded Silhouette Icons', 'folded sheet app icon', 'folded-silhouette', {
      aesthetic: 'Folded Silhouette Icons: one apparent sheet folded once or twice into a compact silhouette that carries the whole app metaphor.',
      subject_treatment: "Build the prompt's subject as an app icon from one sheet with one or two decisive folds, every fold carrying meaning rather than decoration.",
      color_and_tone: 'Three related values separating front, back and void, with strong silhouette contrast.',
      lighting_and_shadow: 'Broad side light with a short contact shadow and soft, even fold shading.',
      texture_and_material: 'Thin apparent thickness, matte surface and an almost texture-free finish.',
      camera_and_composition: 'Compact silhouette with one main void and folds visible from the chosen view.',
      atmosphere_and_mood: 'Built lightness and a quiet surprise, crisp rather than crumpled or fragile.',
      rendering_and_quality: 'Still recognizable as a flat silhouette once material and shadow are removed.',
    ...
    A('R-APP-02', 'Nested Object Tokens', 'two-object fitted app icon', 'nested-token', {
      aesthetic: 'Nested Object Tokens: two simplified objects fit into each other so their relationship, not a pile of accessories, tells what the app does.',
      subject_treatment: "Fit the prompt's subject together with one related object so the fit explains the function, each keeping its one essential trait.",
      color_and_tone: 'Two color families for the two pieces, their values well apart in greyscale.',
      ...
      camera_and_composition: 'Primary piece holds most of the mass, the secondary filling a void without hiding it.',
      atmosphere_and_mood: 'Complicity and a satisfying fit, with nothing extra piled on top.',
      rendering_and_quality: 'The relationship reads at small size and stays clear without an outer container.',
    ...
    A('R-APP-03', 'Inlaid Plane Emblems', 'inlaid color plane app icon', 'inlaid-plane', {
      aesthetic: 'Inlaid Plane Emblems: broad color planes set flush into one simple mass, their edges giving hierarchy and a minimal sense of depth.',
      subject_treatment: "Inlay the prompt's subject as two or three broad planes into one simple mass, the joins between color and edge creating minimal depth.",
      color_and_tone: 'Two or three color planes on a neutral base, with one single focus of saturation.',
      ...
      rendering_and_quality: 'The inlay still reads in greyscale without relying on any material texture.',
    ...
    A('R-APP-04', 'Suspended Core Icons', 'suspended core app icon', 'suspended-core', {
      aesthetic: 'Suspended Core Icons: one recognizable core held by two or three visible bridges inside an open outer frame.',
      subject_treatment: "Suspend the prompt's subject as a core held by two or three visible bridges inside an open frame, the core recognizable even without the frame.",
      color_and_tone: 'Core in the dominant value, support in lower contrast, voids kept open.',
      lighting_and_shadow: 'Broad side light with contact shadows at each bridge and clear support.',
      texture_and_material: 'Solid matte materials with believable thickness and softly controlled edges.',
      camera_and_composition: 'Core slightly offset, frame open on one side like an unfinished ring.',
    ...
    A('R-APP-05', 'Compressed Diorama Icons', 'micro diorama app icon', 'compressed-diorama', {
      aesthetic: 'Compressed Diorama Icons: a tiny space of two or three planes condenses one action, seen through one consistent camera.',
      subject_treatment: "Condense the prompt's subject into a micro space of two or three planes that shows one action, dropping any scenery that does not explain it.",
      color_and_tone: 'Short palette with the background lower in contrast than the functional figure.',
      ...
      camera_and_composition: 'Consistent camera and compressed depth, the space kept inside the icon outline.',
    ...
    A('R-APP-06', 'Carved Relief Pictograms', 'carved relief app icon', 'carved-relief', {
      aesthetic: 'Carved Relief Pictograms: broad reliefs and carved hollows with one or two levels of depth define the icon under a simple outer silhouette.',
      subject_treatment: "Carve the prompt's subject as a broad relief with one or two levels of hollowing, keeping a simple outer silhouette.",
      color_and_tone: 'Clear value relationships between raised surface and hollow, one optional accent.',
      ...
      camera_and_composition: 'Relief concentrated in one region, with a smooth resting zone beside it.',
      atmosphere_and_mood: 'Serene solidity, with information discovered slowly through carved depth.',
    ...
    A('R-APP-07', 'Inflated Junction Icons', 'soft inflated joint app icon', 'inflated-junction', {
      aesthetic: 'Inflated Junction Icons: soft tubes or masses join at tense necks with readable gaps, each junction adding meaning to the icon.',
      subject_treatment: "Join the prompt's subject from soft inflated masses through tense junctions that keep gaps open, every join contributing to the meaning.",
      color_and_tone: 'Two moderately saturated tones with clean shadow values.',
      lighting_and_shadow: 'Broad light with soft highlights that describe tension without heavy gloss.',
      texture_and_material: 'Smooth elastic surface, seams shown only where they explain construction.',
      ...
      rendering_and_quality: 'Junction thickness changes coherently without melting parts together.',
    ...
    A('R-APP-08', 'Paper-Hinge Characters', 'jointed flat-piece app character', 'paper-hinge', {
      aesthetic: 'Paper-Hinge Characters: characters or symbols articulated from flat pieces joined by visible simple hinges.',
      subject_treatment: "Articulate the prompt's subject from flat pieces joined by simple visible hinges, keeping its identity, proportions and correct number of parts.",
    ...
    A('R-APP-09', 'Stepped Crystal Forms', 'stepped faceted app icon', 'stepped-crystal', {
      aesthetic: 'Stepped Crystal Forms: volume built from broad stepped planes and a few counted facets under one dominant silhouette.',
      subject_treatment: "Build the prompt's subject from broad steps and a few counted facets, placing the dominant silhouette before any material.",
      ...
      rendering_and_quality: 'The structure stays recognizable when rendered opaque and monochrome.',
    ...
    A('R-APP-10', 'Layer-Window Icons', 'reveal-window app icon', 'layer-window', {
      aesthetic: 'Layer-Window Icons: one controlled opening in the front layer reveals a second layer that completes the metaphor.',
      subject_treatment: "Cut one opening into the prompt's subject so it reveals a second essential shape behind it, using a single window only.",
      ...
      rendering_and_quality: 'The metaphor reads with window and content together, no fine detail needed.',
