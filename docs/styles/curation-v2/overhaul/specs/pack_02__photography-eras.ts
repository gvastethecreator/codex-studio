  ...
  updates: {
    'SP02-046': {
      ...
      briefs: [
        ...
        'Daguerreotype of a modern electric guitar on a stand, rendered in the same cool silver plate with fine hairline scratches and a tarnish bloom, still clearly a modern instrument. No text or logo.',
    ...
    'SP02-129': {
      briefs: [
        'Silver-plate tonality photograph of a chrome stand mixer on a marble kitchen counter, the modern appliance unchanged, cool silver tones and mirror-dark shadows, no period props. No text or logo.',
