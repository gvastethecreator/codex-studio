...
export function style(
  ...
  return {
    ...
    texture_and_material: pad(texture, 9, 'visible at a glance as the signature of the style.'),
    camera_and_composition: pad(camera, 9, 'arranged so the subject still reads at a glance.'),
