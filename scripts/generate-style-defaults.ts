...
function presetBasePromptOverride(preset?: StyleRuntimePreset) {
  ...
  const overrides: Record<string, string> = {
    ...
    'SP06-116':
      'A stealth-game shadow-readability style-card with one original quiet object, rooftop vent form, small drone shadow, or architectural occluder study split into blue-black safe shadows, sodium detection-light pools, sharp visibility contrast, and silent tactical composition. Keep readable concealment zones without guards. Do not show guards, soldiers, weapons, city rooftop cliche, security camera prop, UI markers, readable text, logos, markets, libraries, or corridors.',
    'SP06-117':
      'An arcade-racing velocity-neon style-card with one original sleek hover object, aerodynamic creature silhouette, route marker, or abstract vehicle-fragment pushed through magenta-cyan-lime speed trails, glossy reflections, diagonal lane rhythm, and forward momentum. Keep racing energy without needing a car. Do not show readable billboards, UI overlays, city street cliche, cockpit, guns, text, logos, markets, libraries, or corridors.',
    'SP06-118':
