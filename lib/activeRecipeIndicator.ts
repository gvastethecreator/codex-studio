...
const ACTIVE_RECIPE_INDICATORS: Record<RegisteredRecipeId, ActiveRecipeIndicator> = {
  'animation-sequence': {
    ...
    title: 'Animation',
    summary: 'Frame GIF',
    toneClassName: 'border-orange-400/2 bg-orange-500/10 text-orange-100',
  ...
  remaster: {
    ...
    toneClassName: 'border-amber-400/2 bg-amber-500/10 text-amber-100',
  ...
  spritesheet: {
    ...
    title: 'Sprite Sheet',
    summary: 'Sprite grid',
    toneClassName: 'border-emerald-400/2 bg-emerald-500/10 text-emerald-100',
  ...
  'sprite-atlas': {
    ...
    title: 'Sprite Atlas',
    summary: 'Atlas build',
    toneClassName: 'border-indigo-400/2 bg-indigo-500/10 text-indigo-100',
  ...
  cinematic: {
    ...
    title: 'Cinematic',
    summary: 'Shot plan',
    toneClassName: 'border-rose-400/2 bg-rose-500/10 text-rose-100',
  ...
  'character-lab': {
    ...
    title: 'Character Lab',
    summary: 'Action set',
    toneClassName: 'border-cyan-400/2 bg-cyan-500/10 text-cyan-100',
  ...
  character: {
    ...
    title: 'Character',
    summary: 'Sheet spec',
    toneClassName: 'border-violet-400/2 bg-violet-500/10 text-violet-100',
  ...
  camera: {
    ...
    title: 'Camera',
    summary: 'View orbit',
    toneClassName: 'border-sky-400/2 bg-sky-500/10 text-sky-100',
  ...
  timeline: {
    ...
    title: 'Timeline',
    summary: 'Frame chain',
    toneClassName: 'border-lime-400/2 bg-lime-500/10 text-lime-100',
