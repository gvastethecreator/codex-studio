...
const IMAGEGEN_SKILL_PATH = 'C:\\Users\\cristian\\.codex\\skills\\.system\\imagegen\\SKILL.md';
  ...
  if (!threadId) {
    const thread = await client.request('thread/start', {
      ...
      developerInstructions:
        ...
        'Do not copy files from C:\\Users\\cristian\\.codex\\generated_images manually. ' +
...
function closeImagegenSession(sessionKey: string, options?: { invalidatePersistedThread?: boolean }) {
