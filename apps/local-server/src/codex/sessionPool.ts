...
export interface SessionPool {
  getOrCreateSession(sessionKey: string, execution?: JobExecutionOptions | null): Promise<SessionHandle>;
    ...
    if (!threadId) {
      ...
      const thread = await client.request('thread/start', {
        ...
        developerInstructions:
          ...
          'Save or expose the resulting image so Codex Studio can import it, and report the exact local file path when available. ' +
