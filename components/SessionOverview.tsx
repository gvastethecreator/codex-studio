            ...
            <div>
                ...
                <div className="grid grid-cols-3 gap-2">
                    <div className="rounded-xl border border-white/5 bg-white/5 p-3">
                        <span className="block text-[8px] uppercase tracking-widest text-zinc-600">Batches</span>
                        <span className="text-lg font-black text-zinc-200">{batchesCount}</span>
                    </div>
                    <div className="rounded-xl border border-white/5 bg-white/5 p-3">
                    ...
                    <div className="rounded-xl border border-white/5 bg-white/5 p-3">
                        <span className="block text-[8px] uppercase tracking-widest text-zinc-600">Active Jobs</span>
