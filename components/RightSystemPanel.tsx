  ...
  return (
    <SidePanel position="right" label="SYSTEM">
      <div className="flex flex-col gap-6">
        <div>
          <h3 className="text-[10px] font-black text-zinc-500 uppercase tracking-widest mb-2 px-1">
            Data Vault
          </h3>
          <div className="flex flex-col gap-2">
            ...
            >
              ...
              />
              <span className="text-[10px] font-black text-zinc-300 uppercase tracking-widest group-hover:text-white">
                Import Vault
              </span>
            </button>
            <button
        ...
        <div>
          <h3 className="text-[10px] font-black text-zinc-500 uppercase tracking-widest mb-3 px-1">
            Environment
          </h3>
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <div
                className={`w-2 h-2 rounded-full ${isQueueOpen ? 'bg-accent-400 shadow-[0_0_8px_rgba(var(--accent-500),0.8)]' : 'bg-zinc-700'}`}
              />
            </div>
          </button>
          ...
          >
            ...
            <div
              className={`w-2 h-2 rounded-full ${isBackgroundEnabled ? 'bg-accent-400 shadow-[0_0_8px_rgba(var(--accent-500),0.8)]' : 'bg-zinc-700'}`}
            />
          </button>
        </div>
      </div>
