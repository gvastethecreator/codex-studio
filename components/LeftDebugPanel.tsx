            ...
            <div className="flex flex-col gap-6">
                <div>
                    <div className="flex items-center gap-2 mb-3">
                        ...
                        <h3 className="text-[10px] font-black text-zinc-400 uppercase tracking-widest">Workspaces</h3>
                    </div>
                ...
                <div>
                    <div className="flex items-center gap-2 mb-3">
                        ...
                        <h3 className="text-[10px] font-black text-zinc-400 uppercase tracking-widest">Local Metrics</h3>
                    </div>
