...
export const LimitReachedModal: React.FC<LimitReachedModalProps> = ({ isOpen, onClose, onDownloadAndClear, batchCount }) => {
                ...
                >
                    <div className="p-6 border-b border-white/5 flex items-center justify-between bg-red-500/5">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-lg font-black uppercase tracking-widest text-white">Storage Limit Reached</h2>
                            </div>
                        </div>
                        <button
                            onClick={onClose}
                    ...
                    <div className="p-6">
                        <p className="text-zinc-300 text-sm mb-6 leading-relaxed">
                            You have reached the maximum recommended number of batches ({batchCount}). To prevent performance issues and data loss, we recommend downloading your images as a ZIP file and clearing your workspace.
                        </p>
