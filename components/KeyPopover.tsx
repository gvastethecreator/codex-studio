    ...
    <AnimatePresence>
      {isOpen && (
        <MotionDiv
          ...
          className="absolute bottom-full right-0 z-100 mb-3 w-72 origin-bottom-right rounded-xl border border-white/2 bg-zinc-900 shadow-[0_20px_50px_rgba(0,0,0,0.6)] backdrop-blur-3xl"
          onClick={(e) => e.stopPropagation()}
        >
          <div className="p-4 border-b border-white/2 flex items-center justify-between">
          ...
          <div className="p-4 space-y-4">
            ...
            <div className="pt-2 border-t border-white/2 flex flex-col gap-2">
          ...
          {/* Arrow */}
          <div className="absolute top-full right-4 size-3 bg-zinc-900 border-r border-b border-white/2 rotate-45 -translate-y-1.5"></div>
        </MotionDiv>
      )}
    </AnimatePresence>
  );
