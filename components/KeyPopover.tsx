        ...
        >
          <div className="p-4 border-b border-white/5 flex items-center justify-between">
            <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-black text-white uppercase tracking-widest">Credenciales Pro</span>
            </div>
          ...
          <div className="p-4 space-y-4">
            <p className="text-[10px] text-zinc-400 leading-relaxed">
                Codex ImageGen usa tu sesion local de <span className="text-accent-400 font-bold">Codex/ChatGPT</span>. No requiere API key; el backend local supervisa codex app-server.
            </p>
            ...
            <div className="pt-2 border-t border-white/5 flex flex-col gap-2">
                <div className="flex items-center gap-2 opacity-60">
                    ...
                    <span className="text-[8px] font-bold text-zinc-400 uppercase">Gestion Local por Codex</span>
                </div>
                <a 
