...
import { Trash2, X, Plus, ArrowLeft, Home, Activity } from 'lucide-react';
                                    ...
                                    `}
                                        >
                                            {ws.lastImage ? (
                                                ...
                                                <div className={`w-full h-full bg-linear-to-br ${gradientClass} flex items-center justify-center`}>
