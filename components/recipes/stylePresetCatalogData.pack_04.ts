...
const packManifestFiles = import.meta.glob('./styles/manifests/packs/pack_04.yaml', {
  query: '?raw',
  import: 'default',
  eager: false,
}) as Record<string, ManifestGlobLoader>;

const presetManifestFiles = import.meta.glob('./styles/manifests/presets/pack_04/*.yaml', {
  query: '?raw',
  import: 'default',
  eager: false,
}) as Record<string, ManifestGlobLoader>;
