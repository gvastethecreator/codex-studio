...
> = {
  ...
  pack_19: () =>
    import('./stylePresetCatalogData.pack_19').then((module) =>
      module.loadStylePresetCatalogPackData(),
    ),
  pack_20: () =>
    import('./stylePresetCatalogData.pack_20').then((module) =>
      module.loadStylePresetCatalogPackData(),
    ),
  pack_21: () =>
    import('./stylePresetCatalogData.pack_21').then((module) =>
      module.loadStylePresetCatalogPackData(),
    ),
  pack_22: () =>
    import('./stylePresetCatalogData.pack_22').then((module) =>
      module.loadStylePresetCatalogPackData(),
    ),
  pack_23: () =>
    import('./stylePresetCatalogData.pack_23').then((module) =>
      module.loadStylePresetCatalogPackData(),
    ),
  pack_24: () =>
    import('./stylePresetCatalogData.pack_24').then((module) =>
      module.loadStylePresetCatalogPackData(),
    ),
  pack_25: () =>
    import('./stylePresetCatalogData.pack_25').then((module) =>
      module.loadStylePresetCatalogPackData(),
    ),
};
