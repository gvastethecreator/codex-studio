...
export const GENERATED_STYLE_PRESETS = [
  ...
  },
  {
    ...
    style: {
      ...
      creative_brief:
        'The world clicks together one stud at a time, every surface a testament to constructive imagination. Light glances across glossy ABS plastic as if the bricks themselves hum with readiness. Block by block, the ordinary rebuilds itself into the extraordinary.',
    },
  },
  {
    id: 'SP11-002',
  ...
  },
  {
    ...
    style: {
      ...
      creative_brief:
        "Button eyes hold gaze without judgment, stitched smiles promising the unconditional comfort that smells like nursery safety and bedtime years. Polyester filling shifts with every embrace, reshaping the plush companion into the unique form of each child's specific love. Softness as sanctuary, velvet-touch tenderness manufactured by the dozen yet made singular by affection.",
    },
  },
  {
    id: 'SP11-005',
  ...
  },
  {
    ...
    style: {
      ...
      creative_brief:
        'Four-hole buttons replace the windows to the soul, threading a line between cute and deeply wrong, cross-stitch tension pulling burlap into a grimace. Needle-hole pupils stare without blinking from a face constructed of fabric and sawdust and careful-what-you-wish-for. Handcrafted horror presses its needle into the uncanny valley where dolls watch you back with button eyes that remember.',
    },
  },
  {
    id: 'SP11-021',
