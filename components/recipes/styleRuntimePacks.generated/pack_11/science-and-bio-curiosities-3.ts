...
export const GENERATED_STYLE_PRESETS = [
  ...
  },
  {
    ...
    style: {
      ...
      creative_brief:
        'Thread counts become resolution in a textile grid where French knots serve as pixels and satin stitch bands render smooth gradients. The hoop holds tension across a canvas woven from patience and generational knowledge, each needle pass a quiet act of preservation. Thread-painted artistry blooms on Aida cloth, the slow meditation of hands that speak through floss and fabric.',
    },
  },
  {
    id: 'SP11-034',
  ...
  },
  {
    ...
    style: {
      ...
      creative_brief:
        "Glass towers breathe through chlorophyll veins, spiraling toward a sun that promises instead of threatens. Art Nouveau curves intertwine with solar panels in a city where technology and nature stopped fighting and started collaborating. Tomorrow glows green against a sky scrubbed clean of yesterday's exhaust, butterflies tracing paths through vertical forests of hope.",
    },
  },
  {
    id: 'SP11-013',
  ...
  },
  {
    ...
    style: {
      ...
      creative_brief:
        'Brass gears interlock in clockwork conspiracy while steam hisses through copper pipes toward a future that was never built. The airship captain checks her pocket watch as pressure gauges tremble at the edge of invention and disaster in equal measure. Victorian engineering dreams in polished mahogany and coal-fired aspiration, aether-science wearing goggles and carrying a differential engine in its waistcoat.',
    },
  },
  {
    id: 'SP11-039',
