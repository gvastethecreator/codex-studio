...
export const GENERATED_STYLE_PRESETS = [
  {
    ...
    "style": {
      ...
      "creative_brief": "A frozen millisecond of chaos where surface tension stretches to breaking and droplets hang in midair like glass beads scattered from a broken necklace. Specular highlights trace the curvature of every splash crown, and foam particles cluster at the periphery like witnesses to the impact. The image is pure kinetic poetry, a fluid sculpture arrested at the apex of its drama."
    }
  },
  {
    "id": "SP03-016",
  ...
  },
  {
    ...
    "style": {
      "aesthetic": "Luminous alien forest, Avatar Pandora style, bioluminescent wonder, floating mountains, connected ecosystem",
  ...
  },
  {
    ...
    "style": {
      ...
      "creative_brief": "The alphabet becomes sculpture — bold letterforms constructed from unexpected materials, each character a tiny world of physical texture and volumetric presence. Studio lighting preserves typographic readability while revealing the material truth of every serif and stem, and vibrant brand-expression hues give the message chromatic urgency. The image is a visual proclamation: a headline you could walk around, typography that demands to be touched as much as read."
    }
  },
  {
    "id": "SP03-064",
