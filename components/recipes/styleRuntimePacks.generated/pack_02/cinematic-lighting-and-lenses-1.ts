...
export const GENERATED_STYLE_PRESETS = [
  ...
  },
  {
    ...
    style: {
      ...
      creative_brief:
        'After midnight, the city writes itself in reflections—pink and cyan bleeding across wet pavement like spilled ink from a broken sign. Every puddle holds a fractured cosmos, every slick surface doubles the loneliness, and the rain does not wash anything clean; it only makes the glow run deeper.',
    },
  },
  {
    id: 'SP02-071',
