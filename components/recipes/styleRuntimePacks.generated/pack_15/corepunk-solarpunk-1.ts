...
export const GENERATED_STYLE_PRESETS = [
  {
    ...
    "style": {
      "aesthetic": "High-altitude agrarian solarpunk focused on food sovereignty and shared stewardship.",
      "form_and_line": "Stepped cultivation bands, cooperative work clusters, and gently spiraled circulation paths.",
      "color_palette": "Canopy leaf green, sun-cream limestone, and clear irrigation blue.",
      "lighting_setup": "Early sun wash with soft atmospheric haze and controlled terrace highlights.",
      "material_texture": "Laminated timber, hydrated soil beds, translucent greenhouse membranes, and woven shade cloth.",
      "render_quality": "Production-grade environment concept balancing atmospheric softness with operational readability.",
      "spatial_distortion": "Ascending terrace perspective that reveals crop zoning, access routes, and communal nodes.",
      "atmosphere": "Productive calm, collective pride, and grounded optimism.",
      "key_features": "Tiered agro-cells, gravity-fed water channels, seedling cooperatives, and shared harvest platforms.",
      "creative_brief": "A mountainside food district where cultivation, logistics, and community life interlock into a visibly resilient daily system."
    }
  },
  {
    "id": "SP15-002",
    ...
    "style": {
      ...
      "form_and_line": "Continuous ribbon tracks, modular station canopies, and pedestrian-first circulation arcs.",
      ...
      "material_texture": "Satin bio-composite panels, laminated glass fins, and dense hanging foliage mats.",
      "render_quality": "Production-ready environmental concept with strong wayfinding legibility.",
      "spatial_distortion": "S-curve rail perspective that links foreground station life to distant garden districts.",
      "atmosphere": "Efficient calm, civic trust, and everyday delight in shared infrastructure.",
      "key_features": "Quiet glide trains, pollinator bridges, open ticketless platforms, shade-rich promenades.",
      "creative_brief": "A post-car transit corridor where stations operate as neighborhood gardens and movement feels frictionless, inclusive, and joyful."
    }
  },
  {
    "id": "SP15-003",
  ...
  },
  {
    ...
    "style": {
      "aesthetic": "Cloudbelt solarpunk habitat where atmospheric water capture drives orchard urbanism.",
      "form_and_line": "Lightweight mist towers, braided footbridges, and canopy-layered dwelling modules.",
      ...
      "material_texture": "Micro-mesh catchers, oiled light timber, ceramic cistern skins, and dewy fruit wax.",
      "render_quality": "Premium atmospheric concept art with clear infrastructure storytelling.",
      "spatial_distortion": "Diagonal bridge network perspective traversing staggered orchard terraces.",
      "atmosphere": "Quiet fertility, climatic intelligence, and gentle communal rhythm.",
      "key_features": "Condensation towers, drip-fed orchard lanes, suspended homes, and visible storage cisterns.",
      "creative_brief": "A fog-dependent hillside settlement that transforms airborne moisture into food, shade, and neighborhood life."
    }
  },
  {
    "id": "SP15-005",
    ...
    "style": {
      "aesthetic": "Hydrological solarpunk commons where storage, cooling, and gathering are one system.",
      "form_and_line": "Concentric reservoir rings, stepped seating edges, and radial circulation paths.",
      ...
      "material_texture": "Porous pale stone, evaporative ceramic fins, brushed alloy rails, and laminar water films.",
      "render_quality": "Editorial-grade civic concept art with clean public-space readability.",
      "spatial_distortion": "Amphitheater-like basin depth emphasizing a multifunctional water-energy core.",
      "atmosphere": "Collective comfort, thermal relief, and visible ecological stewardship.",
      "key_features": "Thermal battery basins, refill kiosks, mist pergolas, and everyday mixed-age occupancy.",
      "creative_brief": "A neighborhood plaza that openly displays water management and passive cooling as beautiful public infrastructure rather than hidden utilities."
    }
  },
  {
    "id": "SP15-006",
    ...
    "style": {
      "aesthetic": "Ceremonial agro-future gathering focused on seed stewardship and intergenerational exchange.",
      "form_and_line": "Circular assembly choreography, suspended seed banners, and archive-centric focal geometry.",
      "color_palette": "Pollinator yellow, germination green, and clay-coral warmth.",
      "lighting_setup": "Golden-hour festival light with soft lantern accents around archive stations.",
      "material_texture": "Linen pennants, seed capsules, polished timber kiosks, and woven biofiber mats.",
      "render_quality": "Dense-but-readable event concept art with strong crowd and signage hierarchy.",
      ...
      "key_features": "Seed swap counters, stewardship oath wall, crop lineage displays, and communal planting table.",
      "creative_brief": "A civic seed festival where joy, governance, and biodiversity literacy merge into a single public ritual."
    }
  },
  {
    "id": "SP15-007",
  ...
  },
  {
    ...
    "style": {
      "aesthetic": "Pluvial-ritual solarpunk where civic acoustics and rain harvesting co-design public life.",
      "form_and_line": "Tiered chorus groupings, channeling roof geometries, and rhythmic cable spans between blocks.",
      "color_palette": "Storm blue, oxidized copper, and rain-saturated leaf green.",
      "lighting_setup": "Silver overcast with specular puddle highlights and translucent canopy glow.",
      "material_texture": "Ribbed catchment panels, tensioned waterproof textiles, wet moss edges, and ceramic gutters.",
      "render_quality": "Poetic production concept art balancing lyrical mood with infrastructural clarity.",
      "spatial_distortion": "Stepped roof-chain perspective descending toward a central cistern amphitheater.",
      "atmosphere": "Collective tenderness, climatic intelligence, and calm ceremonial focus.",
      "key_features": "Resonant cistern bowls, rooftop choir tiers, rainfall channels, and participatory water meters.",
      "creative_brief": "A rain event transformed into civic music, where each rooftop both sings and stores water for the neighborhood."
    }
  },
  {
    "id": "SP15-009",
  ...
  },
  {
    ...
    "style": {
      ...
      "material_texture": "Cross-laminated timber, recycled composite railings, cork flooring, and living vine screens.",
      "render_quality": "Clean editorial concept scene with strong human scale and pedagogical clarity.",
      "spatial_distortion": "Ascending spiral perspective linking ground labs to elevated garden observatories.",
      "atmosphere": "Curious optimism, civic care, and intergenerational collaboration.",
      "key_features": "Outdoor seminar terraces, energy dashboards, seed libraries, and maker-learning nodes.",
      "creative_brief": "A public learning hub where children and adults study ecology through the very systems that power and cool the building."
    }
  },
  {
    "id": "SP15-099",
    ...
    "style": {
      ...
      "creative_brief": "A solarpunk transit node where mobility is shaded, quiet, and beautifully integrated with nature."
    }
  },
  {
    "id": "SP15-100",
    ...
    "style": {
      ...
      "creative_brief": "A solarpunk neighborhood market that turns every roof into shared productive land."
    }
  },
  {
    "id": "SP15-101",
  ...
  },
  {
    ...
    "style": {
      ...
      "creative_brief": "A solarpunk civic heart where energy, climate, and public life are harmonized in one bright atrium."
    }
  }
