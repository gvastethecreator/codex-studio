...
export const GENERATED_STYLE_PRESETS = [
  ...
  },
  {
    ...
    style: {
      aesthetic:
        'Golden-hour-silhouette-only scenes, characters as warm-rim-lit-black-shapes against blazing-orange-sky, no-facial-features-just-backlit-contours, school-rooftop-confession-scene, seaside-sunset-promise, Makoto-Shinkai-sky-intensity applied to pure-silhouette, lens-flare-diffraction-halos, emotion-conveyed-entirely-through-posture-and-sky-color, Your-Name-twilight-magic, longing-expressed-through-light-alone',
      form_and_line:
        'Pure-silhouette-contours, rim-light-hair-edge-definition, no-internal-lines-just-shape, wind-blown-hair-edge-reading, posture-as-only-storytelling-tool',
      color_palette:
        'Sun-blast-orange, blazing-magenta-sky, deep-shadow-black, gold-rim-light, purple-dusk-transition, pink-cloud-glow, cyan-sky-remnant-at-zenith, warm-to-cool-atmosphere-gradient',
      lighting_setup:
        'Extreme-backlight-silhouette, golden-hour-rim-light, lens-flare-artifacts, atmospheric-haze-diffusion, crepuscular-ray-god-beams',
      material_texture:
        'Lens-flare-bloom, anamorphic-streak-flare, atmospheric-dust-mote-haze, cloud-layer-softness, sun-disk-overexposure-burn, film-grain-in-shadows',
      render_quality:
        'Golden-hour-silhouette-anime, Makoto-Shinkai-sky-rendering, romance-through-light, sunset-color-script-artistry, emotion-in-silhouette',
      spatial_distortion:
        'Characters-as-black-cutouts-against-sky, sun-position-composition-anchor, negative-space-sky-dominance, extreme-depth-created-by-atmosphere',
      atmosphere:
        'Romantic, nostalgic, bittersweet-longing, end-of-day-magic, unspoken-confession, tearful-twilight, beautiful-goodbye',
      key_features:
        'Pure-silhouette-against-sunset, golden-hour-rim-light, Shinkai-sky-intensity, lens-flare-halos, atmospheric-haze-depth, school-rooftop-setting, cloud-glow-gradients',
      creative_brief:
        'Faces dissolve into the sun, leaving only the truth of posture — the tilt of a head, the distance between two bodies standing on a rooftop at the edge of day. The sky does all the speaking: magenta bleeding into gold, cloud glow carrying the confession that lips cannot form. Emotion in silhouette is the purest kind, because nothing distracts from what the heart is already projecting onto the light.',
    },
  },
  {
    id: 'SP05-113',
  ...
  },
  {
    ...
    style: {
      aesthetic:
        "Anime drawn in chalk on classroom blackboard, eraser-dust-haze in air, chalk-dust-on-uniform-sleeves, school-confession-written-in-chalk-alongside-drawing, smudged-by-someone's-hand-edge, temporary-after-school-art, sunset-light-through-classroom-windows, clubroom-blackboard-announcement energy, chalk-breaking-mid-stroke accident, impermanent-creativity-before-janitor-erases-it",
      form_and_line:
        'Chalk-variable-thickness strokes, smudge-softened-edges, eraser-ghost-trails-from-previous-board-content, chalk-dust-halo-around-lines',
      color_palette:
        'White-chalk on green-blackboard, yellow-chalk, pink-chalk, cyan-chalk, dust-muted pastels, green-board-background, grey-eraser-smudge bloom',
      lighting_setup:
        'Afternoon-sun-through-classroom-windows, fluorescent-ceiling-overhead, chalk-dust-mote-light-scattering, board-reflection-gloss-corners',
      material_texture:
        'Slate-blackboard-grain, chalk-dust-powder-residue, eraser-felt-streak-lines, chalk-holder-metal-tray, dust-on-floor-below-board, smudge-fingerprint-texture',
      render_quality:
        'Chalkboard-sketch-anime, classroom-art-aesthetic, temporary-creation-beauty, eraser-dust-atmosphere, school-memory-nostalgia',
      spatial_distortion:
        'Blackboard-rectangle-framing, chalk-tray-bottom-border, classroom-window-reflection-on-board, after-school-empty-classroom-context',
      atmosphere:
        "Nostalgic, temporary, after-school-secret, youthful-creativity, fleeting-school-memory, clubroom-intimacy, janitor's-coming-soon urgency",
      key_features:
        'Chalk-on-green-blackboard-texture, eraser-ghost-trails, chalk-dust-atmosphere-haze, smudged-edges, classroom-window-light-reflection, chalk-tray-border, chalk-breaking-texture',
      creative_brief:
        "The drawing lives only until the janitor arrives — chalk dust suspended in afternoon window light like a prayer against erasure. Smudge ghosts of yesterday's lessons bleed through today's art, palimpsest of a school day sliding into the secret hour when the blackboard becomes a canvas. Every line carries the texture of impermanence, and that is exactly what gives it weight.",
    },
  },
  {
    id: 'SP05-102',
