  ...
  },
  {
    ...
    style: {
      ...
      key_features:
        'Cinematic cel-era drama, emotional action choreography, iconic silhouette design, bold visual storytelling',
      creative_brief:
        'Ornate costume ribbons and feathered wings float through magical circles as card motifs cascade like promises, each decorative emblem rendered with the delicate precision of a love letter written in sparkles. The 90s cel warmth wraps tender magic in shimmering softness, a visual lullaby for the heart.',
    },
  },
  {
    id: 'SP05-183',
  ...
  },
  {
    ...
    style: {
      ...
      key_features:
        'Emotion-forward facial acting, expressive eye detail, tender micro-expressions, heartfelt gesture language',
      creative_brief:
        'Silk whispers across marble as candlelight catches the single tear-track of a duchess caught between duty and desire, voluminous gowns rustling with the weight of unspoken declarations. Every glance across the ballroom is a treaty signed in rose petals — palace intrigue rendered in the language of lace and longing.',
    },
  },
  {
    id: 'SP05-042',
    ...
    style: {
      ...
      key_features:
        'Emotion-forward facial acting, expressive eye detail, tender micro-expressions, heartfelt gesture language',
      creative_brief:
        'A rose spins in midair and the world transforms into a stage where duels are declarations of the soul fought in silhouette against impossible architecture. Floating staircases ascend toward towers that hold every question worth asking — surrealism as the truest mirror of emotional truth, sword-clash echoing through the theater of becoming.',
    },
  },
  {
    id: 'SP05-043',
    ...
    style: {
      ...
      key_features:
        'Emotion-forward facial acting, expressive eye detail, tender micro-expressions, heartfelt gesture language',
      creative_brief:
        'Rain drums against the window of a room filled with the quiet courage of broken people learning to love themselves, seasonal light pooling in watercolor washes across found-family tenderness. Every gentle expression is a hard-won victory, warmth blooming through the cracks like spring after the longest winter.',
    },
  },
  {
    id: 'SP05-044',
