...
export const TrashModal: React.FC<TrashModalProps> = ({ isOpen, onClose, trash, onRestore, onRestoreAll, onEmpty }) => {
                ...
                >
                    ...
                    <div className="p-6 border-b border-white/5 flex items-center justify-between bg-zinc-900/50">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-lg font-black uppercase tracking-widest text-white">Recycle Bin</h2>
                    ...
                    <div className="flex-1 overflow-y-auto p-6 custom-scrollbar">
                        {trash.length === 0 ? (
                            <div className="h-full flex flex-col items-center justify-center text-center py-20">
                                ...
                                <h3 className="text-zinc-400 font-bold uppercase tracking-widest text-sm mb-1">Bin is Empty</h3>
                                <p className="text-zinc-600 text-xs max-w-[240px]">Deleted generations and evicted batches will appear here for recovery.</p>
                            </div>
                        ) : (
